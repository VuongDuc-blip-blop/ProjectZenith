...
namespace ProjectZenith.Api.Write.Migrations
{
    ...
    [Migration("20250901032252_AddAppScreenShotAndTag")]
    partial class AddAppScreenShotAndTag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectZenith.Contracts.Models.App", b =>
                {
                    ...
                    b.ToTable("Apps", null, t =>
                        {
                            t.HasCheckConstraint("CK_Apps_Status", "[Status] IN ('Draft', 'ValidationFailed', 'PendingApproval', 'PendingValidation', 'Published', 'Rejected', 'Banned')");
                        });
                });
