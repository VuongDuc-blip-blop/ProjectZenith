...
namespace ProjectZenith.Api.Write.Services.Commands.UserDomain
{
    public class LoginCommandHandler
    {
        ...
        public async Task<(string Token, Guid RefreshTokenId, string RefreshToken, UserLoggedInEvent Event)> HandleAsync(LoginCommand command, CancellationToken cancellationToken)
        {
            ...
            return (tokenString, refreshTokenId, refreshToken, userEvent);
        }
    }
}
